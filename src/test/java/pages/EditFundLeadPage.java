...
public class EditFundLeadPage {
 ...
 // Locators for Lead history
    ...
    private String sources = "(//p[@class='font-medium text-xs sm:text-sm break-words whitespace-normal'])[10]";
    private String SubSources = "(//p[@class='font-medium text-xs sm:text-sm break-words whitespace-normal'])[11]";
    
    private String alternatecountryCode = "(//p[@class='font-medium text-xs sm:text-sm break-words whitespace-normal'])[12]";
    private String alternatePhone = "(//p[@class='font-medium text-xs sm:text-sm break-words whitespace-normal'])[13]";
    private String ReferralType = "(//p[@class='font-medium text-xs sm:text-sm break-words whitespace-normal'])[14]";
    private String referralName = "(//p[@class='font-medium text-xs sm:text-sm break-words whitespace-normal'])[15]";
    private String buyingTime = "(//p[@class='font-medium text-xs sm:text-sm break-words whitespace-normal'])[18]";
    private String Priority = "(//p[@class='font-medium text-xs sm:text-sm break-words whitespace-normal'])[19]";
    private String Budget = "(//p[@class='font-medium text-xs sm:text-sm break-words whitespace-normal'])[20]";
    private String area = "(//p[@class='font-medium text-xs sm:text-sm break-words whitespace-normal'])[21]";
    private String projectCategory = "(//p[@class='font-medium text-xs sm:text-sm break-words whitespace-normal'])[22]";
    private String UnitType = "(//p[@class='font-medium text-xs sm:text-sm break-words whitespace-normal'])[23]";
    private String LeadType = "(//p[@class='font-medium text-xs sm:text-sm break-words whitespace-normal'])[24]";
    private String Location = "(//p[@class='font-medium text-xs sm:text-sm break-words whitespace-normal'])[25]";
...
//        Lead details on history 
    ...
    public void editLeadBasic(String projectName, String fname, String lname, String mail, String note) throws InterruptedException {
        ...
        // Thread.sleep(2000);
        // String ExpectedLeadOwner = page.textContent(SigIn_Name).trim();
        // System.out.println("ExpectedLeadOwner: "+ExpectedLeadOwner);
        // String leadOwner = "(//div[@role='button' and contains(@aria-label,'View details for') and contains(normalize-space(.), '" + ExpectedLeadOwner + "')]//span[contains(@class,'rounded-full')])[2]";
        // String leadOwnername = page.textContent(leadOwner).trim();
        // System.out.println("leadOwnername: "+leadOwnername);

        // String getPhoneNo = page.textContent(leadOwner).trim();
        //  System.out.println("getPhoneNo: "+getPhoneNo);

...
//        Lead details on history 
        ...
        String actualSourceinHistory = page.textContent(sources).trim();
        ...
        assert actualSourceinHistory.equals(expectedSource) 
        : "Full name mismatch. Expected: " + expectedSource + ", Got: " + actualSourceinHistory;
    ...
    public void addLeadWithAdditional(String projectName, String fname, String lname, String country,
            String phone, String mail, String source, String subSource, String note,
             String AdditionalCountrycode, String AdditionalPhone, 

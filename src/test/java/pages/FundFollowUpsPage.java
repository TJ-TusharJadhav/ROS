...
public class FundFollowUpsPage {
    ...
    private String EnterLostResion = "(//input[@placeholder='Enter custom reason'])[1]";
    
    private String StageInHistory = "(//p[@class='font-medium text-xs sm:text-sm break-words whitespace-normal'])[6]";
    private String CommentsInHistory = "(//p[@class='font-medium text-xs sm:text-sm break-words whitespace-normal'])[8]";
    private String SubStageInHistory = "(//p[@class='font-medium text-xs sm:text-sm break-words whitespace-normal'])[9]";
...
//    private String datetime = LocalDateTime.now().plusMinutes(10).format(DateTimeFormatter.ofPattern("dd/MM/yyyy hh:mm a"));
    private String Enterdatetime = "08/10/2025 10:30 PM";
    private String verifydatetime = "Oct 8, 2025, 10:30 PM";

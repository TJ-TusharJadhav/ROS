...
//        // Open page
//        page.navigate("https://beta.shivalikgroup.com/event/registration/68cab4312a13fc520774949b");
//
...
//        page.locator("//h2[@class='mb-2 text-xl font-light lg:text-2xl']").isVisible();
//
